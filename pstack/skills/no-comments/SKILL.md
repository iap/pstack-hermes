...
1. Read `references/comment-sicko.md`, then spawn a delegate with `delegate_task` (role: `leaf`). Pass the scope. Inline the rules verbatim; do not paraphrase or add commentary.
